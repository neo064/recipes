 ...
 *
 */
public class UploadField extends FormComponentPanel<Short> implements FormModeDependable {
	 ...
	 */
	public UploadField(final String id, final String label, final FormMode formMode) {
		super(id);
